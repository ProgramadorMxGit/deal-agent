#!/usr/bin/env python3
"""Wrapper de paridad para `cleanup_outbox_missing_prev_price.py`.

Este script delega en el subcomando consolidado:

    python -m ofertas_hunter saneamiento --task outbox-missing-prev-price [--apply] [--marketplace ...]
...
SQL en `src/ofertas_hunter/saneamiento/tasks/outbox_missing_prev_price.py`).
"""
...
_TASK_NAME = "outbox-missing-prev-price"
