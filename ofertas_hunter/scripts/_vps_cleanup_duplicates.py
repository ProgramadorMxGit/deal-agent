#!/usr/bin/env python3
"""Wrapper de paridad para `_vps_cleanup_duplicates.py`.

Este script delega en el subcomando consolidado:

    python -m ofertas_hunter saneamiento --task outbox-duplicates [--apply] [--marketplace ...]
...
SQL en `src/ofertas_hunter/saneamiento/tasks/outbox_duplicates.py`).
"""
