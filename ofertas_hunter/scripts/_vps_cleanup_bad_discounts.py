#!/usr/bin/env python3
"""Wrapper de paridad para `_vps_cleanup_bad_discounts.py`.

Este script delega en el subcomando consolidado:

    python -m ofertas_hunter saneamiento --task outbox-bad-discounts [--apply] [--marketplace ...]
...
SQL en `src/ofertas_hunter/saneamiento/tasks/outbox_bad_discounts.py`).
"""
...
_TASK_NAME = "outbox-bad-discounts"
